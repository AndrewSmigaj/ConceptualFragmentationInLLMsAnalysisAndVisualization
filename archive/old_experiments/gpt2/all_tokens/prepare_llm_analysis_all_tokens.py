...
class AllTokensLLMDataPreparer:
    ...
    def prepare_complete_llm_analysis(self):
        ...
        llm_data = {
            "experiment_info": {
                "title": "GPT-2 All Tokens (50,257) Trajectory Analysis",
                "description": "Analysis of how GPT-2 organizes its complete vocabulary including words, subwords, punctuation, and special tokens",
                "key_questions": [
...
def main():
    ...
    preparer = AllTokensLLMDataPreparer(base_dir)
